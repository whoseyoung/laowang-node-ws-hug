...
const UUID = process.env.UUID || '99db4d5d-9910-41cd-ab9e-a8c501c03a1e'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'EIE4cknBEWxU0cgcQLuxZN3z8FRQZxFp';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
